<aside class="main-sidebar elevation-4 sidebar-light-olive">
    ...
    <a href="#" class="brand-link">
      <img src="{{ asset('img/favicon-32x32.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"><span class="brand-text ">Hadir<span class="text-logo">In</span></span>
    </a>
